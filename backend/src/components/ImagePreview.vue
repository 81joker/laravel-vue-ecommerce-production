  ...
  <div>
    <div class="flex flex-wrap gap-1">
      ...
      >
        ...
        <span
          class="absolute top-1 right-1 cursor-pointer bg-red-500 text-white rounded-full p-1"
...
watch(
  ...
  () => {
    ...
    if ('props.images' !== undefined) {
      imageUrl.value = [
        ...imageUrl.value,
        ...props.images.map((imageItem) => ({ ...imageItem, isProp: true })), // Convert array of strings to array of objects with id and url properties
      ]
    }
