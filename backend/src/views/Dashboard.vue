<template>
  ...
  <div class="grid grid-cols-1 md:grid-cols-4 gap-3">
    <!-- ACtivae Customers -->
    <div
      class="animate-fade-in-down bg-white py-6 px-5 text-center shadow rounded-lg flex flex-col items-center justify-center"
    >
  ...
  <div
    class="grid grid-rows-1 md:grid-rows-2 md:grid-flow-col grid-cols-1 md:grid-cols-3 gap-3 mt-3"
  >
    <!-- Latest Orders  -->
    <div
      class="col-span-1 md:col-span-2 row-span-1 md:row-span-2 bg-white py-6 px-5 <shadow rounded-lg"
    >
    ...
    <div class="bg-white py-6 px-5 shadow rounded-lg flex flex-col items-center justify-center">
      <template v-if="!loading.orderByCountry">
        <DoughnutChart
          ...
          :height="200"
          :data="orderByCountry"
          v-if="orderByCountry.datasets && orderByCountry.datasets[0].data.length > 0"
        />
      </template>
      <Spinner v-else text="" class="" />
    </div>
