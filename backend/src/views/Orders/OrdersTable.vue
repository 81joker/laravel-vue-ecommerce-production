    ...
    <table class="table-auto w-full">
      ...
      <tbody v-else>
        <tr v-for="orders of orders.data">
          ...
          <td class="border-b p-2">${{ orders.total_price }}</td>
          ...
          <td class="border-b p-2">
            <router-link
              :to="{ name: 'app.orders.view', params: { id: orders.id } }"
              class="w-8 h-8 rounded-full flex items-center justify-center border text-indigo-700 border-indigo-700 hover:bg-indigo-700 hover:text-white"
            >
              <svg
